        ...
        static void Main(string[] args)
        {
            ...
            static void jogada()
            {
                ...
                while (true)
                {
                    ...
                    {
                        escolhaComp = ObterEscolhaComputador();
                        Console.WriteLine("O jogador O escolheu: " + escolhaComp);

                        int linhaComp = (escolhaComp - 1) / 3;
                        int colunaComp = (escolhaComp - 1) % 3;

                        if (jogo[linhaComp, colunaComp] != 'X' && jogo[linhaComp, colunaComp] != 'O')
                        {
                            jogo[linhaComp, colunaComp] = playerAtual;
                            break;
                        }
                    }
                }
